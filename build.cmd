rmdir /s /q build
"%ProgramFiles(x86)%\Microsoft Visual Studio\2017\Professional\MSBuild\15.0\Bin\MSBuild.exe" src\GammaJul.ReSharper.EnhancedTooltip.sln /p:Platform="Any CPU" /p:Configuration=Release
